...
class AINormalizer:
    ...
    def _create_normalization_prompt(self) -> str:
        """Create the AI prompt template for normalization."""
        return """
You are an expert in spectroscopy data analysis. Analyze the provided CSV data and create a normalization plan to convert it to standard spectroscopy format.

Expected Standard Format:
- Column 1: Wavenumber (cm⁻¹), range 400-4000, descending order
- Column 2: Absorbance or Transmittance or Intensity values
...
{{
    ...
    "analysis_notes": "Overall analysis and recommendations"
}}
...
4. Recommending necessary transformations
